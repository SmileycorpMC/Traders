...
public class Item1CountValue extends ItemCountValue {
    
    private Item1CountValue() {}
    ...
    public static <T extends Comparable<T>> Value<T> deserialize(JsonObject object, DataType<T> type) {
        try {
            ...
            return (Value<T>) new Item1CountValue();
        } catch (Exception e) {
            TradersLogger.logError("invalid value for Item1CountValue", e);
        }
        return null;
    }
